...
Quando algum deles precisar citar visual/UX, deve apontar para `assets/css/definicao-padroes.md` ou para uma documentacao especifica do modulo.

## Regra de atualizacao

Ao surgir uma nova regra de aparencia, UX, design ou interface:

1. Se for geral, atualizar `assets/css/definicao-padroes.md`.
...
1. `assets/css/definicao-padroes.md`
